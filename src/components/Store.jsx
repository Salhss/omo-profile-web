  ...
  return (
    <div id="store">
      <div className="w-full flex flex-col items-center h-screen bg-white">
        ...
        <div className="flex justify-center items-center xs:flex-col xs:gap-5 xs:mt-10 md:flex-row md:mt-20 md:gap-10 lg:gap-20">
          <a href="https://shopee.co.id/omohealthysnack" target="_blank">
            <img
              ...
              alt=""
              className="xs:w-[180px] md:w-[300px]"
              data-aos="fade-up"
            />
          </a>
          <a href="https://www.tokopedia.com/omohealthysnack" target="_blank">
            <img
              ...
              alt=""
              className="xs:w-[150px] xs:pb-20 md:pb-0 md:w-[250px]"
              data-aos="fade-up"
            />
          </a>
        </div>
